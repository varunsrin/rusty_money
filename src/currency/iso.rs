...
macro_rules! define_iso {
    (
      ...
      $(
        pub const $currency: &'static IsoCurrency = &IsoCurrency {
      ...
      pub fn find_by_alpha_code(code: &str) -> Option<&'static IsoCurrency> {
        match code {
      ...
      pub fn find_by_num_code(code: &str) -> Option<&'static IsoCurrency> {
        match code {
