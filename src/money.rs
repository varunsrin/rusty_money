...
impl<'a, T: FormattableCurrency> Neg for Money<T> {
    type Output = Money<T>;
...
impl<'a, T: FormattableCurrency> Money<T> {
    ...
    #[inline]
    pub fn add(&self, other: Money<T>) -> Result<Money<T>, MoneyError> {
    ...
    /// Returns `MoneyError::CurrencyMismatch` if the two Money values have different currencies.
    #[inline]
    pub fn sub(&self, other: Money<T>) -> Result<Money<T>, MoneyError> {
        if self.currency != other.currency {
            return Err(MoneyError::CurrencyMismatch {
                expected: self.currency.code(),
                actual: other.currency.code(),
    ...
    #[inline]
    pub fn mul<N: Into<Decimal>>(&self, n: N) -> Result<Money<T>, MoneyError> {
        self.amount
            .checked_mul(n.into())
    ...
    /// Returns `MoneyError::CurrencyMismatch` if the two Money values have different currencies.
    #[inline]
    pub fn compare(&self, other: &Money<T>) -> Result<Ordering, MoneyError> {
        if self.currency != other.currency {
            return Err(MoneyError::CurrencyMismatch {
                expected: self.currency.code(),
                actual: other.currency.code(),
    ...
    #[inline]
    pub fn gt(&self, other: &Money<T>) -> Result<bool, MoneyError> {
    ...
    /// Returns `MoneyError::CurrencyMismatch` if currencies don't match.
    #[inline]
    pub fn gte(&self, other: &Money<T>) -> Result<bool, MoneyError> {
    ...
    /// Returns `MoneyError::CurrencyMismatch` if currencies don't match.
    #[inline]
    pub fn lt(&self, other: &Money<T>) -> Result<bool, MoneyError> {
    ...
    /// Returns `MoneyError::CurrencyMismatch` if currencies don't match.
    #[inline]
    pub fn lte(&self, other: &Money<T>) -> Result<bool, MoneyError> {
    ...
    /// Returns `MoneyError::CurrencyMismatch` if currencies don't match.
    #[inline]
    pub fn eq(&self, other: &Money<T>) -> Result<bool, MoneyError> {
    ...
    /// ```
    pub fn split(&self, n: u32) -> Result<Vec<Money<T>>, MoneyError> {
        use rust_decimal::prelude::ToPrimitive;
    ...
    /// If the division cannot be applied perfectly, it allocates the remainder
    /// to some of the shares.
    pub fn allocate(&self, shares: Vec<u32>) -> Result<Vec<Money<T>>, MoneyError> {
        if shares.is_empty() {
            return Err(MoneyError::InvalidRatio);
        }
...
impl<T: FormattableCurrency> fmt::Display for Money<T> {
